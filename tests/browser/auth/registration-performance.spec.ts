...
test.describe('Registration Performance & Accessibility', () => {
  ...
  test('should load registration page within performance targets', async ({ page }) => {
  ...
  test('should handle form interactions with good responsiveness', async ({ page }) => {
    await registrationPage.goto();
  ...
  test('should meet accessibility standards', async ({ page }) => {
    ...
    const confirmPasswordLabel = page.locator('label[for="password_confirmation"]');
  ...
  test('should maintain performance with multiple rapid submissions', async ({ page }) => {
    await registrationPage.goto();
