          ...
          {step === 1 && (
            <>
              <LabeledTextInput
                ...
                error={
                  errors.email ||
                  (flash?.errors as Record<string, string> | undefined)
                    ?.email ||
                  null
                }
              />
          ...
          {step === 2 && (
            <>
              <LabeledTextInput
                ...
                value={data.username}
                onChange={(e) =>
                  setData('username', (e.target as HTMLInputElement).value)
                }
                error={
                  errors.username ||
                  (flash?.errors as Record<string, string> | undefined)
              ...
              <LabeledTextInput
                ...
                onChange={(e) =>
                  setData('displayName', (e.target as HTMLInputElement).value)
                }
                error={
                  (flash?.errors as Record<string, string> | undefined)
                    ?.displayName || null
